...
var Practice01 = function Practice01() {
  ...
  var draw = function draw() {
    for (var ii = 0; ii < 50; ++ii) {
      ...
      gl.uniform4f(colorUniformLocation, Math.random(), Math.random(), Math.random(), 0.1); // Draw the rectangle.
