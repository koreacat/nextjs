    ...
    <div className={cx('container')} style={{height: '10000px'}}>
      <div className={cx('sticky')}>
        <div className={cx('slideContainer')}>
          ...
          <div className={cx('slide', 'text1')} ref={el => setRef('text1', el)}>
            취업의<br/>상식
          </div>

          <div className={cx('slide', 'circle')} ref={el => setRef('circle', el)}></div>

          <div className={cx('slide', 'circle')} ref={el => setRef('circle2', el)}>
            <div className={cx('slide', 'text2')} ref={el => setRef('text2', el)}>
              취업의<br/>상식을 깨다.
            </div>
          </div>
