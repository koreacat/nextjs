...
const faqInfoList = [
  {
    ...
    answerTitle: '잡다매칭에서는 간단한 프로필과 역량정보로 면접 제안을 받을 수 있습니다.',
    answer:
      'AI가 구직자의 역량과 기업의 매칭조건을 분석하여 서로에게 최적의 상대를 추천하기 때문에 가능합니다. 더 이상 공고를 찾느라 애쓰지 않아도, 의미 없는 공고 추천에 헤매지 않아도 됩니다. 합격가능성까지 고려한 최적의 포지션을 AI가 상시로 추천해주는 플랫폼, 프로필 한 번 등록하면 어느 포지션이든 손쉽게 지원하고 면접 제안을 받을 수 있는 플랫폼, 잡다매칭으로 취업에 성공하세요!',
    type: 'type2',
  },
  {
    category: '잡다매칭 프로세스',
    question: '잡다매칭은 어떻게 진행되나요?',
    answerTitle: '간단합니다. 프로필 입력, 역검(AI역량검사) 응시, 선호정보만 입력하면 준비 끝!',
    answer:
