...
import {createProgram, createShader} from "../common/util";
...
// Fill the buffer with the values that define a rectangle.
	...
	return (
		<div>
			<Head>
				<script id="vertex-shader-2d" type="notjs" dangerouslySetInnerHTML={{
					__html: `
				...
				<script id="fragment-shader-2d" type="notjs" dangerouslySetInnerHTML={{
					__html: `
